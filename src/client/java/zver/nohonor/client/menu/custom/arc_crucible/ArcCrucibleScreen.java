package zver.nohonor.client.menu.custom.arc_crucible;
...
public class ArcCrucibleScreen extends AbstractContainerScreen<ArcCrucibleMenu> {
    ...
    public ArcCrucibleScreen(ArcCrucibleMenu menu, Inventory inventory, Component title) {
