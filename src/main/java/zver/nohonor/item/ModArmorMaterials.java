...
public class ModArmorMaterials {
    ...
    public static final ResourceKey<EquipmentAsset> PEARL_SILVER_KEY = ResourceKey.create(REGISTRY_KEY, Identifier.fromNamespaceAndPath(NOHONOR.MOD_ID, "pearl_silver"));
    public static final ResourceKey<EquipmentAsset> STORM_ELYTRA_KEY = ResourceKey.create(REGISTRY_KEY, Identifier.fromNamespaceAndPath(NOHONOR.MOD_ID, "storm_elytra"));
    public static final ResourceKey<EquipmentAsset> EXTERMINATION_ELYTRA_KEY = ResourceKey.create(REGISTRY_KEY, Identifier.fromNamespaceAndPath(NOHONOR.MOD_ID, "extermination_elytra"));


    public static final ArmorMaterial PEARL_SILVER_MATERIAL = new  ArmorMaterial(27,
            ArmorMaterials.makeDefense(1, 3, 5, 2, 7),
            20,
            SoundEvents.ARMOR_EQUIP_GOLD,
            0,
            0,
            ModTags.Items.PEARL_SILVER_REPAIR,
            PEARL_SILVER_KEY
    );
